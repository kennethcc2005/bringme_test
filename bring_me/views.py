...
# Todo App
from bring_me.serializers import RegistrationSerializer
from bring_me.serializers import UserSerializer, TodoSerializer
from bring_me.models import Todo

def index(request):
    return HttpResponse("Hello, world. You're at the bring_me index.")
